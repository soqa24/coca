...
export function initArcticlesSlider(params = {}) {
  const selector = '.articles-swiper';
  ...
  new Swiper(selector, {
    ...
    breakpoints: {
      ...
      769: {
        ...
        spaceBetween: 3, // Можно оставить 20 или поставить 15, как вам нужно
      },
      993: {
      ...
      // От 1201px до 1439px
      1201: {
        slidesPerView: 2.5, // Оставляем 2 слайда, если дизайн не требует 3
